  ...
  return (
    <footer className='w-full mb-[100px]md:mb-5 pb-10' id='contact'>
      ...
      <div className='flex flex-col items-center'>
        ...
        <p className='test-white-200 md:mt-10 my-5 text-center'>
          Reach out to me today and let&apos;s discuss how I can help you acheive your goals.
        </p>
        <a href="mailto:contato@fernandofilho.com">
          <MagicButton 
      ...
      <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
        <p className='md:test-base test-sm md:font-normal font-light'>Copyright © 2024 Fernando Filho</p>
